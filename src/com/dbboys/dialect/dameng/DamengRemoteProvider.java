...
public final class DamengRemoteProvider implements RemoteDatabaseProvider {
    ...
    public List<RemoteInstallStepSpec> buildInstallStepSpecs() {
        return List.of(
                ...
                new RemoteInstallStepSpec("remote.install.dameng.step8.name", "启动服务并修改密码",
                        "remote.install.dameng.step8.desc",
                        "启动达梦数据库服务，等待服务就绪后修改SYSDBA默认密码。", true, true),
                new RemoteInstallStepSpec("remote.install.dameng.step9.name", "安装示例数据",
                        "remote.install.dameng.step9.desc",
