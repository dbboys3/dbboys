...
public final class DamengRemoteProvider implements RemoteDatabaseProvider {
    ...
    public List<RemoteInstallStepSpec> buildInstallStepSpecs() {
        return List.of(
                ...
                new RemoteInstallStepSpec("remote.install.dameng.step4.name", "解压安装包",
                        "remote.install.dameng.step4.desc",
                        "解压zip安装包至安装目录(/opt/dmdbms)，并设置目录权限。", true, true),
                new RemoteInstallStepSpec("remote.install.dameng.step5.name", "初始化数据库实例",
                        "remote.install.dameng.step5.desc",
                        "使用dminit工具初始化数据库实例，配置字符集、页大小、大小写敏感、兼容模式等参数。", true, true),
                new RemoteInstallStepSpec("remote.install.dameng.step6.name", "注册系统服务",
                        "remote.install.dameng.step6.desc",
                        "使用dm_service_installer.sh注册systemd系统服务，设置开机自启。", true, true),
                new RemoteInstallStepSpec("remote.install.dameng.step7.name", "启动服务并修改密码",
                        "remote.install.dameng.step7.desc",
                        "启动达梦数据库服务，等待服务就绪后修改SYSDBA默认密码。", true, true),
                new RemoteInstallStepSpec("remote.install.dameng.step8.name", "安装示例数据",
                        "remote.install.dameng.step8.desc",
                        "导入达梦示例模式(DMHR)的建表和数据脚本。（可选，默认不选中）", true, false)
        );
    }
