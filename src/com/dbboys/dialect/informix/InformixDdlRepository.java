...
public final class InformixDdlRepository implements DdlRepository {
    private static final int DEFAULT_QUERY_TIMEOUT_SECONDS = 30;
    private static final Logger log = LogManager.getLogger(InformixDdlRepository.class);
    ...
    private static void appendNormalTableDefinition(
        ...
        for (String triggerName : triggers) {
            ddl.append("\n").append(new InformixDdlRepository().printTrigger(connection, triggerName));
        }
    }
    ...
    public long countDatabaseExportItems(Connection connection, String databasename) throws SQLException {
        ...
        try {
            ...
            InformixMetadataRepository metadataRepository = new InformixMetadataRepository();
