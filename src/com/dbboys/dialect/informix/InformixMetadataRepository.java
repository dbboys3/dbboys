...
public class InformixMetadataRepository implements com.dbboys.core.MetadataRepository {
    ...
    private static final String SQL_DATABASES_DEFAULT = """
            ...
            order by
            case when name in ('sysmaster','sysuser','sysadmin','sysutils','sysha','syscdr','syscdcv1','informix','sys')
