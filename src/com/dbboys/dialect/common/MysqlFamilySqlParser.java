...
/**
 * Shared SQL parser for the MySQL family.
 * Encapsulates MySQL-specific statement detection (CREATE PROCEDURE/FUNCTION/TRIGGER
 * with BEGIN...END body, DELIMITER directive handling is done by the common segmenter).
 */
public abstract class MysqlFamilySqlParser extends CommonSqlParser {
