...
public final class OracleRemoteProvider implements RemoteDatabaseProvider {
    ...
    public List<RemoteInstallStepSpec> buildInstallStepSpecs() {
        return List.of(
                ...
                new RemoteInstallStepSpec("remote.install.oracle.step3.name", "Extract Packages",
                        "remote.install.oracle.step3.desc",
                        "Extract Oracle installation zip(s) into /opt/oracle/staging. Multiple zips merged into same staging dir.", true, true),
