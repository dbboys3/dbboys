...
public final class OracleRemoteProvider implements RemoteDatabaseProvider {
    ...
    public List<RemoteInstallStepSpec> buildInstallStepSpecs() {
        return List.of(
                new RemoteInstallStepSpec("remote.install.oracle.step1.name", "Uninstall Existing Oracle",
                ...
                new RemoteInstallStepSpec("remote.install.oracle.step2.name", "Check /opt Disk Space",
                ...
                new RemoteInstallStepSpec("remote.install.oracle.step5.name", "Configure Kernel Parameters",
                        "remote.install.oracle.step5.desc",
                        "Set kernel parameters (sysctl.conf) and resource limits (limits.conf) for Oracle.", true, true),
                new RemoteInstallStepSpec("remote.install.oracle.step6.name", "Unpack Installation Package",
                        "remote.install.oracle.step6.desc",
                        "Extract Oracle installation zip(s) into /opt/oracle/staging. Skip for RPM packages.", true, true),
                new RemoteInstallStepSpec("remote.install.oracle.step7.name", "Install Binaries",
