...
public interface ConnectionService {
    ...
    default ChangeDefaultDatabaseResult changeDefaultDatabase(Connect connect, CatalogNode database) {
     ...
     */
    ChangeDefaultDatabaseResult changeDefaultDatabase(Connect connect, CatalogNode database, boolean sessionInitOnReconnect);

    default ChangeDefaultDatabaseResult changeSessionDatabase(Connect connect, CatalogNode database) {
     ...
     */
    ChangeDefaultDatabaseResult changeSessionDatabase(Connect connect, CatalogNode database, boolean sessionInitOnReconnect);
    ...
    <T> T withMetaSession(Connect connect, CatalogNode database, SqlWork<T> action) throws Exception;
